...
```
    ...
    train accuracy :  tensor(0.8970)
    vaild accuracy :  tensor(0.9038)
...
```
    ...
    train accuracy :  tensor(0.9187)
    vaild accuracy :  tensor(0.9216)
...
```
    ...
    train accuracy :  tensor(0.9255)
    vaild accuracy :  tensor(0.9281)
...
```
    ...
    train accuracy :  tensor(0.9267)
    vaild accuracy :  tensor(0.9247)
...
>
> 그런데 어떻게 train보다 valid의 정확도가 더 높은지... 알수가없다.


```python
train_accuracy = [0.8970, 0.9187, 0.9255, 0.9272, 0.9267]
valid_accuracy = [0.9038, 0.9216, 0.9281, 0.9266, 0.9247]
x = [1, 2, 3, 4, 5]
